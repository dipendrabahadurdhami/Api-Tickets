...
include_once '../config.php'; // Include your existing connection file
...
// Fetch notification and booking details
$query = "
    SELECT 
...
// Convert booking_date and departure_time to Nepali time (NPT: UTC+5:45)
    ...
    <div class="containers">
        ...
        <?php if ($notification['booking_id']): ?>
            <div class="booking-details">
                ...
                <p><strong>Travel Date:</strong> <?php echo $formatted_booking_date; ?> (Booking Date in AM/PM)</p> <!-- Booking Date -->
                <p><strong>Departure Time:</strong> <?php echo $formatted_departure_time; ?> (AM/PM)</p> <!-- Departure Time -->
            </div>
        <?php else: ?>
            <div class="error-message">
                <p>No booking details associated with this notification.</p>
            </div>
        <?php endif; ?>
